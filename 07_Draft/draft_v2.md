...
> **Status: post-verification draft.** All facts and citations below have been checked against
> primary sources (see `../01_Research/verification_notes.md`); the generic RBI reference from
> `draft_v1.md` has been replaced with three named, dated regulations, and a DPDP Supreme Court
> caveat has been added. This version is content-final. `../04_Final/` applies only formatting
> polish on top of this text -- no further factual changes.
